export const soaps = [
  ...
  },
  {
    ...
    description: `Effective Skin Cleanser: ...
        ...
        Dove Soap Provides Complete And Balanced Nourishment: ...
        Dove Soap Is Anti-Allergi`,
    image: require(`../images/dovesoap.jpg`),
  },
  {
    name: "Lemon & Mint",
    price: "80",
  ...
  },
  {
    ...
    It makes skin soft, gentle and smooth`,
    image: require(`../images/neemsoap.jpg`),
  },
  {
    name: "Goat Milk Soap",
    price: "80",
  ...
  },
  {
    ...
    image: require(`../images/skintighteningsoap.jpg`),
  },
  {
    name: "Fairness Soap",
    price: "80",
    description: `it makes skin tone brighter.
      ...
      How often to be used - Daily for better results!!`,
    image: require(`../images/fairnesssoap.jpg`),
  },
  {
    name: "Anti Tan Soap",
    price: "80",
    description: `removes tan from skin naturally.
      ...
      How often to be used - Daily for better results!!`,
    image: require(`../images/antitansoap.jpg`),
  },
  {
    name: "Letter Soap",
    price: "100",
  ...
  },
  {
    ...
    description: `Rich in Antioxidants.
      ...
      Reduces Damaging Effects of Free Radicals that cause Premature Aging.
      Softens & Smoothes Skin.
      Natural Ingredients.
      `,
    image: require(`../images/greenteasoap.jpg`),
  },
  {
    name: "Candy soap",
    price: "100",
...
export const perfumes = [
  {
    ...
    image: require(`../images/perfumeferrrari.jpg`),
  },
  {
    name: "Romance",
    price: "650",
  ...
  },
  {
    ...
    description: `Brand: Calvin Klein
      Content: 40ml
      Fragrance: Fruity
      Unisex perfume with a mild and lingering fragrance
      Ideal for daily wear
      Clear and transparent bottle`,
  ...
  },
  {
    ...
    description: `100ml classy looking strong fragrance by ISSEY MIYAKE
      ...
      This comes in 100ml bottles strong n elegant looking design.
      `,
    image: require(`../images/issemeyakimenperfume.jpg`),
  },
  {
    name: "Brut",
    price: "850",
...
export const facewash = [
  {
    ...
    description: `Coffee can use it to exfoliate, treat acne, increase blood flow, it gives smooth skin prevents from spots on skin.
      ...
      Removes Dead Skin
      Works Best In Removing Blackheads
      Helps Get Rid Of Flaky Skin.`,
    image: require(`../images/coffeewalnutfacewash.jpg`),
  },
  {
    name: "Neem ",
    price: "120 / 200",
  ...
  },
  {
    ...
    description: `Benefits -
      ...
      #3 Heals dry and dull skin.
      #4 Prevents breakouts.
      #5 Fights ageing.`,
    image: require(`../images/sandalwoodfacewash.jpg`),
  },
  {
    name: "Charcoal",
    price: "120 / 200",
...
export const hairmask = [
  ...
  //   image: require(`../images/keratinhairmask.jpg`),
  // },
];
