            ...
            <div className="home-wrapper" id="home">
                <div className="welcome-container">
                    ...
                    <div className="welcome-text">
                        <p>Bottles Heaven is a Home Grown brand.<br></br> We have <span>HOMEMADE</span> <span className="letter-color welcome-color">SKINCARE</span>&<span className="letter-color welcome-color">BATHING</span> Range of Products,<br></br> which are <span className="letter-color welcome-color">SLS</span>&<span className="letter-color welcome-color">PARABEN FREE</span></p>
                    </div>
                ...
                <div className="home-image-wrapper">
                    ...
                    <div className = "image-container left-part selected"><GiDelicatePerfume  className="perfume"/></div>
                    <div className = "bridge left-part"></div>
                    <div className = "image-container right-part selected"><GiDelicatePerfume  className="perfume"/></div>
                    ...
                    <div></div>
                    <div className='image-container right-part'></div>
                    <div className='bridge right-part'><GiDelicatePerfume  className="perfume"/></div>
                    <div className = "image-container right-part"></div>
                    ...
                    <div className = "image-container right-part selected"><GiDelicatePerfume  className="perfume"/></div>
                    <div className='bridge right-part'></div>
                    <div className = "right-part three"><GiDelicatePerfume  className="perfume"/></div>
                    <div></div>
